...
Supported sites include **av.by**, **Onliner** (catalog, auto, baraholka), **21vek.by**, **Kufar**, **Shop.by**, **Elektrosila (sila.by)**, **5 element**, **OZ.by**, **OMA**, **Emall**, and **e-dostavka**.
...
2. Supported shopping / classifieds hosts listed in the extension manifest (av.by, Onliner sections, 21vek, Kufar, Shop.by, sila.by, 5element.by, oz.by, oma.by, emall.by, e-dostavka.by, including common `www.` variants) — only as web pages you open in your browser; the extension injects scripts to read visible prices and show conversions. **No price data is sent to us.**
